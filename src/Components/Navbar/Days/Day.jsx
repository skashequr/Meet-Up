...
const Day = () => {
    return (
      ...
      >    
        ...
        <img className="rounded-xl h-full w-auto" src="https://buffer.com/cdn-cgi/image/w=1000,fit=contain,q=90,f=auto/library/content/images/size/w1200/2023/10/free-images.jpg" alt="" />
  
        {sliderImageUrl.map((imageUrl, index) => {
          return (
            <div key={index}>
              <div  className="slider mx-3 max-h-[300px] static" >
              <Avatar className="border bg-black absolute left-2 top-2"  shape="circle" size="sm" img="https://img.freepik.com/free-vector/isolated-young-handsome-man-different-poses-white-background-illustration_632498-855.jpg?w=740&t=st=1703989751~exp=1703990351~hmac=9b9d8bd2130e3f16235a9cf8d4f9632ffcd62aa73787fcfe619b1ade5aebf922"/>
              <img src={imageUrl.url} className="rounded-xl" alt="movie" />
