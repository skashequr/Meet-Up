...
const Login = () => {
    return (
        <div className="flex justify-center items-center align-middle lg:mt-24 md:mt-5 sm:mt-0">
       <div className="w-full px-6 py-8 md:px-8 lg:w-1/2 bg-green-50 rounded-3xl">
